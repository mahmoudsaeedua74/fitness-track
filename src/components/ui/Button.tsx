...
const buttonVariants = cva(
  "inline-flex items-center justify-center border-[1px] font-bold rounded-[6px] sm:rounded-[10px] p-[10px] transition-colors duration-200 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        default:
          " text-black-text shadow bg-white hover:bg-black-text hover:text-white transition-all duration-300",
        menu: "bg-white text-black-text hover:bg-highlight-color  w-fit",
        main: "bg-white text-black-text font-medium",
        secondary:
          "bg-white text-secondary-color border-border-color hover:bg-gray-200",
        delete:
          "hover:bg-[#D9534F] bg-[#FDEAEA] text-[#D9534F] hover:text-white border-[#D9534F]",
        expert:
      ...
      size: {
        default: "h-[44px] w-[131px] px-4 py-2",
